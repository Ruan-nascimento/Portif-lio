...
export default function FreeRTOSDemoPage() {
  const { t } = useLanguage();

  const techs = ["C", "FreeRTOS", "Embedded Systems", "Microcontrollers", "Task Scheduling", "Firmware Development"];

  const features = t("project.freertos.features").split(" • ");
    ...
    <main className="min-h-screen py-20 px-6 sm:px-12 max-w-4xl mx-auto flex flex-col justify-center">
      ...
      <div className="flex flex-col gap-6 mb-16">
        ...
        <ScrollReveal variant="fadeUp" delay={0.2} className="flex flex-wrap gap-4 mt-4">
          <Button
            as={Link}
            href="https://github.com/Ruan-nascimento/freeRTOS---demo"
            target="_blank"
            size="md"
